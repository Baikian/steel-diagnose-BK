...
export class parallelCoordinates extends SuperSVGView {
    constructor({ width, height }, ele) {
        ...
        this._parallel = new Parallel({ width: 260, height: 480 }, this._container, this._tooltipInstance, 'ControlPanelMain',this._container);
    }
    render(value,mid,newtest) {
        this._parallel.joinData(value,mid,newtest).render()
    }
}
